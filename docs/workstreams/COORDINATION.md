...
| Temple A3 visual review | `019f6043-95af-73f0-a29f-18b312e8170e` | `E:\Proj\Game-1-temple` via `E:\Proj` / read-only | Independent review of the failed A3 clay evidence. It may write only its separate review log; it cannot alter A3 or production. | `ACK-TEMPLE-REVIEW-START-001`: scope sent; terminal report will define the minimum A4 boundary. |
